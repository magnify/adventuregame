...
You see screenshots only. Not the code, not the last round. Score each scene 1–10 on each line; a scene passes at 8+
...
6. **Mood matches story.** Bright and safe on the street, wide and strange under three suns, closing in on the path, wet and wary in the swamp.
7. **Taste, not template.** Would a good children's illustrator sign this frame? What is the one thing they'd change first?
